module aoxc::neural_bridge {
    ...
    fun command_digest(command: &BridgeCommand): vector<u8> {
        ...
        vector::append(&mut body, b"AOXC_SUI_NEURAL_BRIDGE_V4");
    ...
    entry fun init(
        ...
        assert!(min_confirmations > 0, errors::E_INVALID_ARGUMENT);
    ...
    entry fun set_min_confirmations(
        _cap: &GatewayAdminCap,
        gateway: &mut NeuralGateway,
        next: u16,
    ) {
